...
export default function ListaPresentes({ onConfirmar, onClose }) {
    ...
    const handleConfirmar = () => {
        ...
        if (onClose) onClose();   // ✅ fecha a modal pai
    };
        ...
        <div className='container-presentes'>
            ...
            <div className='lista-presentes'>
                {lista.slice(1).map((item, index) => {
                    // adapte conforme o formato real do seu getListas()
                    ...
                    return (
                        <div
                            ...
                            onClick={() => !jaSelecionado && handleSelecionar(item.nome, `public/assets/Images/Presentes/${item.imagem}`)}
                        >
                            <h3>{nome}</h3>

                            <img src={`public/assets/Images/Presentes/${item.imagem}`} alt={item.nome} />
